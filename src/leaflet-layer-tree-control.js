L.Control.LayerTreeControl = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        //         var leafId = leafTraverser.addLeaf(layerSubTree, layersContainer, layerSubTree, "", 0);
        //         this._layerContainersById[leafId] = {};
        //     }
        // } else {
        //     var leafId = leafTraverser.addLeaf(layerTree, layersContainer, layerTree, "", 0);
        //     this._layerContainersById[leafId] = {};
        // }
    ...
    _addLayer: function (layer, layerId, layerSettings) {
        if (layer) {
            this._layers.push({ id: layerId, layer: layer, name: layerSettings.name, settings: layerSettings });
    ...
    addLayer2: function (layerSettings, parentLayerId) {
        ...
        var leafId = this._leafTraverser.addLeaf(parentLayerSettings, parentContainer, layerSettings, parentLayerId, 0);
